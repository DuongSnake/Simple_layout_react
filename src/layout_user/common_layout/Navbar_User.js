...
function Navbar() {
  const navigate = useNavigate();
    ...
    const navigatePage2 = () => {
    navigate("/user/student-map-critical", { replace: true });
  };
    const navigatePage3 = () => {
    navigate("/user/score-assignment", { replace: true });
  };
            ...
            <ul class="pb-2 space-y-2">
              <li>
                <button type="button"
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Thông tin đồ án</span>
                ...
                <ul id="dropdown-crud" class="space-y-2 py-2">
                  ...
                  <li onClick={navigatePage2}>
                    <a href="/user/student-map-critical"
                      class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Thông tin giáo viên phản biện</a>
                  </li>
                  <li onClick={navigatePage3}>
                    <a href="/user/score-assignment"
                      class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Tra cứu điểm đồ án</a>
                  </li>
                </ul>
              </li>
            </ul>
