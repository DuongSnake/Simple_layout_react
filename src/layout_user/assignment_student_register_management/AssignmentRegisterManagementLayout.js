...
import { selectListAssignmentRegisterUserSiteApi, createApi, updateApi, deleteApi } from "./AssignmentRegisterManagementAPI";
import { selectAllInstructorApi , selectAllStudentApi } from "../../layout_admin/user_management/UserManagementAPI";
                ...
                <form>
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <select id="category-major" value={formDataEdit.studentId || ''} onChange={handleStudentChangeEditModal}
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="note" value={formDataEdit.assignmentStudentRegisterName} onChange={handleInputChangeEdit} id="edit-admission-period-name"
                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                ...
                <form>
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input type="text" name="assignmentStudentRegisterName" value={formData.assignmentStudentRegisterName} onChange={handleInputChange} id="admission-period-name"
                        className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                      <label htmlFor="category-student" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên sinh viên</label>
                      <select id="category-student" onChange={handleStudentChange}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        {Array.isArray(listAllStudents) && listAllStudents.length ? (
                          <>
          ...
          <div onClick={(e) => e.stopPropagation()} className="relative w-full max-w-md px-4 md:h-auto">
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
              ...
              <div className="p-6 pt-0 text-center">
                ...
                <h3 className="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">Bạn có chắc chắn xóa đăng ký đồ án này không?</h3>
                <button
