...
import { selectListApi, createApi, updateApi, deleteApi } from "./AdmissionPeriodManagementAPI";
...
const { RangePicker } = DatePicker;
  ...
  const listDataAdmissionPeriod = useSelector(state => state.admissionPeriodManagement.selectList.data);
  const totalRecord = useSelector(state => state.admissionPeriodManagement.selectList.totalRecord);
  const listDataAdmissionPeriodLoading = useSelector(state => state.admissionPeriodManagement.selectList.loading);
