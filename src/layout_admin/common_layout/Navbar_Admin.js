            ...
            <ul class="pb-2 space-y-2">
              ...
              <li>
                <button type="button"
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Trước bảo vệ</span>
                ...
                <ul id="dropdown-crud" class="space-y-2 py-2">
                  <li onClick={navigatePage}>
                    <a href="/admin/user-management"
                      class="text-base text-gray-900 rounded-lg flex items-center p-2 group hover:bg-gray-100 transition duration-75 pl-11 dark:text-gray-200 dark:hover:bg-gray-700">Tài khoản</a>
                  </li>
